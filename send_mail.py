...
def prepare_and_send_email(recipient, subject, message_text):
    ...
    try:
        ...
        #create message
        msg = create_message('adarsh2020it009@abesit.edu.in', recipient,
...
if __name__ == '__main__':
    prepare_and_send_email('adarshvpandey2004@gmail.com', 'Greeting from Global Infoventures', 'This is a test email for our upcoming app')
